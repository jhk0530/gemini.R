...
#'
#' # For text content
#' token_count_text <- countTokens(jsonkey = "YOURAPIKEY.json", model_id = "1.5-flash", content = "Hello, world!")
...
#' token_count_image <- countTokens(jsonkey = "YOURAPIKEY.json", model_id = "1.5-flash", content = image_content)
...
#' )
#' token_count_parts <- countTokens(jsonkey = "YOURAPIKEY.json", model_id = "1.5-flash", content = content_parts)
